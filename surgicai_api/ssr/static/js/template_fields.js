...
`),r=r.trim(),r}function K(){if(!g)return{content:"",fields:[]};const t=R(),e=B();return{content:t,fields:e}}function X(n){}function J(n){}function N(){const n=g;n&&(n.on("text-change",function(t,e,i){if(i!=="user"||x)return;console.log("Text change detected:",t),clearTimeout(window.fieldStylingTimeout),window.fieldStylingTimeout=setTimeout(()=>{console.log("Debounced field styling triggered"),S()},500);const o=t.ops;if(o&&o.length>0){const l=o[o.length-1];if(console.log("Last operation:",l),l.insert==="/"){console.log("Slash detected! Showing menu...");const r=n.getSelection();r&&(w=r.index-1,setTimeout(()=>{ie(r.index)},10))}else u&&l.insert&&typeof l.insert=="string"&&ee()}}),document.addEventListener("click",function(t){u&&!t.target.closest(".slash-menu")&&!t.target.closest(".ql-editor")&&v()}),document.addEventListener("keydown",function(t){t.key==="Escape"&&u?v():u&&t.key==="Enter"?(t.preventDefault(),t.stopPropagation(),ne()):u&&(t.key==="ArrowUp"||t.key==="ArrowDown")?(t.preventDefault(),t.stopPropagation(),te(t.key==="ArrowDown"?1:-1)):t.key==="Backspace"&&!u?Z(t):(t.key==="ArrowLeft"||t.key==="ArrowRight")&&!u&&Y(t)},!0))}function Y(n){const t=g;if(!t)return;const e=t.getSelection();if(!e||e.length>0)return;const i=e.index,o=n.key==="ArrowLeft",l=n.key==="ArrowRight";if(o&&i>0){const r=t.getText(0,i),s=/\[(ai)?field:\s*([^\]]+)\]$/,d=r.match(s);if(d){const a=d[0],f=i-a.length;console.log("Arrow left: jumping to start of field:",a),n.preventDefault(),n.stopPropagation(),t.setSelection(f,0,"user")}}else if(l&&i<t.getLength()-1){const r=t.getText(i),s=/^\[(ai)?field:\s*([^\]]+)\]/,d=r.match(s);if(d){const a=d[0],f=i+a.length;console.log("Arrow right: jumping to end of field:",a),n.preventDefault(),n.stopPropagation(),t.setSelection(f,0,"user")}}}function Z(n){const t=g;if(!t)return;const e=t.getSelection();if(!e||e.length>0)return;const i=e.index;if(i===0)return;const o=t.container.querySelector(".ql-editor");if(!o)return;const l=t.getBounds(i-1,1),r=document.elementFromPoint(o.getBoundingClientRect().left+l.left+l.width,o.getBoundingClientRect().top+l.top+l.height/2);let s=null;if(r&&(s=r.closest(".field-component, .aifield-component"),!s&&r.previousSibling&&r.previousSibling.classList&&(r.previousSibling.classList.contains("field-component")||r.previousSibling.classList.contains("aifield-component"))&&(s=r.previousSibling)),!s){const d=t.getText(0,i),a=/\[(ai)?field:\s*([^\]]+)\]$/,f=d.match(a);if(f){const p=f[0],h=i-p.length;console.log("Deleting field (text pattern):",p,"from position",h),n.preventDefault(),n.stopPropagation(),t.deleteText(h,p.length,"user"),t.setSelection(h,0,"user"),setTimeout(()=>{S()},10);return}}if(s){console.log("Deleting field component:",s),n.preventDefault(),n.stopPropagation();const d=s.getAttribute("data-field-text");if(d){const f=t.getText().indexOf(d.replace(/\[field:\s*/,"[field: "));f!==-1&&(t.deleteText(f,d.length,"user"),t.setSelection(f,0,"user"))}s.remove(),setTimeout(()=>{S()},10)}}function ee(){if(!u||w===-1)return;const n=g;if(!n)return;const t=n.getSelection();if(!t)return;const e=n.getText(w+1,t.index-w-1);console.log("Text after slash:",e),z(e)}function te(n){if(!c)return;const t=c.querySelectorAll(".slash-menu-item");t.length!==0&&(m=Math.max(0,Math.min(t.length-1,m+n)),M())}function ne(){if(!c)return;const n=c.querySelectorAll(".slash-menu-item");if(n.length===0)return;const t=n[m];t&&t.click()}function M(){if(!c)return;c.querySelectorAll(".slash-menu-item").forEach((t,e)=>{e===m?t.style.backgroundColor="#f3f4f6":t.style.backgroundColor="transparent"})}function ie(n){const t=g;if(!t||u)return;console.log("Showing slash menu at index:",n);const e=t.getBounds(n),i=t.container.getBoundingClientRect();C={x:i.left+e.left,y:i.top+e.top+e.height+5},console.log("Menu position:",C),z(""),u=!0}function v(){c&&(c.remove(),c=null),u=!1,w=-1,m=0}function z(n=""){c&&c.remove();const e=[{label:"AI Field",icon:"🤖",description:"Insert a predefined AI field",action:"ai"},{label:"Field",icon:"📝",description:"Create a custom field",action:"field"}].filter(i=>i.label.toLowerCase().startsWith(n.toLowerCase()));if(e.sort((i,o)=>i.label.localeCompare(o.label)),m=Math.min(m,e.length-1),e.length===0){v();return}c=document.createElement("div"),c.className="slash-menu",c.style.cssText=`
        position: fixed;
        left: ${C.x}px;
        top: ${C.y}px;
        background: white;
        ...
        font-size: 14px;
    `,e.forEach((i,o)=>{const l=oe(i.label,i.icon,i.description);l.addEventListener("click",()=>{v(),i.action==="field"?re():i.action==="ai"&&de()}),c.appendChild(l)}),document.body.appendChild(c),M()}function oe(n,t,e){const i=document.createElement("div");return i.className="slash-menu-item",i.style.cssText=`
        padding: 12px 16px;
        cursor: pointer;
        display: flex;
        align-items: center;
...
`||d==="	")break}if(l!==-1){const s=r-l;e.deleteText(l,s,"silent"),e.insertText(l,i,"silent"),e.setSelection(l+i.length,0,"silent")}else e.insertText(r,i,"silent"),e.setSelection(r+i.length,0,"silent")}else{const l=e.getLength();e.insertText(l-1,i,"silent"),e.setSelection(l-1+i.length,0,"silent")}setTimeout(()=>{console.log("Applying field styling after insertion"),S()},50)}function S(){const n=g;if(!n)return;if(x){console.log("Already applying styling, skipping...");return}x=!0,console.log("Applying field styling...");const t=n.container.querySelector(".ql-editor");if(!t){console.log("No editor element found"),x=!1;return}const e=n.getSelection(),i=n.hasFocus();let o=null;if(e&&i){const d=window.getSelection();d.rangeCount>0&&(o=d.getRangeAt(0).cloneRange())}const l=document.createTreeWalker(t,NodeFilter.SHOW_TEXT,null,!1),r=[];let s;for(;s=l.nextNode();)/\[(ai)?field:\s*[^\]]+\]/.test(s.textContent)&&r.push(s);if(r.length===0){x=!1;return}r.forEach(d=>{const a=d.textContent,f=/\[(ai)?field:\s*([^\]]+)\]/g;let p;const h=[];for(;(p=f.exec(a))!==null;)h.push({fullMatch:p[0],fieldName:p[2].trim(),isAIField:p[1]==="ai",startIndex:p.index,endIndex:p.index+p[0].length});if(h.length>0){const T=d.parentNode;let b=a,E=0;h.forEach(y=>{const q=document.createElement("div");q.innerHTML=y.isAIField?se(y.fieldName):le(y.fieldName);const P=q.firstChild,$=b.substring(0,y.startIndex-E),k=b.substring(y.endIndex-E);if($){const F=document.createTextNode($);T.insertBefore(F,d)}if(T.insertBefore(P,d),k===""||k.charAt(0)!==" "){const F=document.createTextNode("​");T.insertBefore(F,d)}b=k,E=y.endIndex}),b?d.textContent=b:T.removeChild(d)}}),i&&setTimeout(()=>{try{if(n.focus(),o){const d=window.getSelection();d.removeAllRanges(),d.addRange(o)}else e&&n.setSelection(e.index,e.length,"silent")}catch(d){console.log("Could not restore cursor position:",d),n.focus()}},1),setTimeout(()=>{x=!1,console.log("Styling application complete")},10)}function le(n){const t=`field-${Date.now()}-${Math.random().toString(36).substr(2,9)}`,e=`<span class="field-component" data-field-text="[field: ${n}]" data-field-name="${n}" id="${t}" contenteditable="false" style="display: inline-block; background: #fefce8; border: 1px solid #eab308; border-radius: 4px; padding: 2px 6px 4px 6px; margin: 0 2px; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; cursor: default; vertical-align: baseline; line-height: 1.2; isolation: isolate;">
    ...
    </span>`;return console.log("Generated AI field HTML:",e),e}function re(){const n=O("Create Field","Enter a name for this field:"),t=function(a){a.key==="Enter"&&a.target!==e&&(a.preventDefault(),a.stopPropagation())};document.addEventListener("keydown",t,!0);const e=document.createElement("input");e.type="text",e.placeholder="e.g., Patient Name, Surgeon Name",e.style.cssText=`
        width: 100%;
        padding: 8px 12px;
    ...
    `,e.addEventListener("focus",function(){this.style.borderColor="#3b82f6",this.style.boxShadow="0 0 0 3px rgba(59, 130, 246, 0.1)"}),e.addEventListener("blur",function(){this.style.borderColor="#d1d5db",this.style.boxShadow="none"});const i=document.createElement("div");i.style.cssText=`
        ...
        margin-top: 16px;
    `;const o=A("Cancel","secondary"),l=A("Create Field","primary"),r=()=>{document.removeEventListener("keydown",t,!0),n.remove()};o.addEventListener("click",r),l.addEventListener("click",()=>{const a=e.value.trim();if(a){let f=_(a);console.log("Creating field with name:",a,"and ID:",f),H(a,!1),r()}else e.style.borderColor="#ef4444",e.focus()}),e.addEventListener("keydown",function(a){a.key==="Enter"?(a.preventDefault(),l.click()):a.key==="Escape"&&(a.preventDefault(),r())}),i.appendChild(o),i.appendChild(l);const s=n.querySelector(".modal-content");s.appendChild(e),s.appendChild(i);const d=n.remove;n.remove=function(){document.removeEventListener("keydown",t,!0),d.call(this)},setTimeout(()=>e.focus(),100)}function de(){const n=O("Select AI Field","Choose a predefined AI field to insert:"),t=document.createElement("div");t.style.cssText=`
        max-height: 300px;
        overflow-y: auto;
        margin: 16px 0;
    ...
    `,D.forEach((l,r)=>{const s=document.createElement("div");s.className="ai-field-option",s.style.cssText=`
        ...
        justify-content: flex-end;
        margin-top: 16px;
    `;const i=A("Cancel","secondary");i.addEventListener("click",()=>{n.remove()}),e.appendChild(i);const o=n.querySelector(".modal-content");o.appendChild(t),o.appendChild(e)}function O(n,t){const e=document.createElement("div");e.className="field-modal",e.style.cssText=`
        position: fixed;
        top: 0;
        left: 0;
        right: 0;
    ...
    `;return t==="primary"?(e.style.cssText=i+`
        ...
        `,e.addEventListener("mouseenter",function(){this.style.backgroundColor="#2563eb",this.style.borderColor="#2563eb"}),e.addEventListener("mouseleave",function(){this.style.backgroundColor="#3b82f6",this.style.borderColor="#3b82f6"})):(e.style.cssText=i+`
            ...
            border-color: #d1d5db;
            color: #374151;
        `,e.addEventListener("mouseenter",function(){this.style.backgroundColor="#f9fafb"}),e.addEventListener("mouseleave",function(){this.style.backgroundColor="white"})),e}function ae(){v(),document.querySelectorAll(".field-modal").forEach(t=>t.remove()),window.fieldStylingTimeout&&(clearTimeout(window.fieldStylingTimeout),window.fieldStylingTimeout=null),g=null,u=!1,c=null,x=!1,W.clear()}function ce(){document.readyState==="loading"?document.addEventListener("DOMContentLoaded",function(){setTimeout(L,100)}):setTimeout(L,100)}window.initializeFields=L;window.getQuillInstance=I;window.insertField=Q;window.updateField=j;window.removeField=U;window.getAllFields=B;window.getTextWithFields=R;window.validateFields=V;window.toggleFieldsHighlight=G;window.exportWithFields=K;window.importWithFields=X;window.handleFieldShortcuts=J;window.setupFieldEventListeners=N;window.cleanupFields=ae;ce();
