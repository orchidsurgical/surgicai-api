...
`),r=r.trim(),r}function Y(){if(!g)return{content:"",fields:[]};const t=R(),e=N();return{content:t,fields:e}}function Z(n){}function ee(n){}function z(){const n=g;n&&(n.on("text-change",function(t,e,i){if(i!=="user"||x)return;console.log("Text change detected:",t),clearTimeout(window.fieldStylingTimeout),window.fieldStylingTimeout=setTimeout(()=>{console.log("Debounced field styling triggered"),b()},500);const o=t.ops;if(o&&o.length>0){const l=o[o.length-1];if(console.log("Last operation:",l),l.insert==="/"){console.log("Slash detected! Showing menu...");const r=n.getSelection();r&&(v=r.index-1,setTimeout(()=>{O(r.index)},10))}else u&&l.insert&&typeof l.insert=="string"&&ie()}}),document.addEventListener("click",function(t){u&&!t.target.closest(".slash-menu")&&!t.target.closest(".ql-editor")&&S()}),document.addEventListener("keydown",function(t){t.key==="Escape"&&u?S():u&&t.key==="Enter"?(t.preventDefault(),t.stopPropagation(),le()):u&&(t.key==="ArrowUp"||t.key==="ArrowDown")?(t.preventDefault(),t.stopPropagation(),oe(t.key==="ArrowDown"?1:-1)):t.key==="Backspace"&&!u?ne(t):(t.key==="ArrowLeft"||t.key==="ArrowRight")&&!u&&te(t)},!0))}function te(n){const t=g;if(!t)return;const e=t.getSelection();if(!e||e.length>0)return;const i=e.index,o=n.key==="ArrowLeft",l=n.key==="ArrowRight";if(o&&i>0){const r=t.getText(0,i),s=/\[(ai)?field:\s*([^\]]+)\]\[\/\1?field\]$/,d=r.match(s);if(d){const a=d[0],f=i-a.length;console.log("Arrow left: jumping to start of field:",a),n.preventDefault(),n.stopPropagation(),t.setSelection(f,0,"user")}}else if(l&&i<t.getLength()-1){const r=t.getText(i),s=/^\[(ai)?field:\s*([^\]]+)\]\[\/\1?field\]/,d=r.match(s);if(d){const a=d[0],f=i+a.length;console.log("Arrow right: jumping to end of field:",a),n.preventDefault(),n.stopPropagation(),t.setSelection(f,0,"user")}}}function ne(n){const t=g;if(!t)return;const e=t.getSelection();if(!e||e.length>0)return;const i=e.index;if(i===0)return;const o=t.container.querySelector(".ql-editor");if(!o)return;const l=t.getBounds(i-1,1),r=document.elementFromPoint(o.getBoundingClientRect().left+l.left+l.width,o.getBoundingClientRect().top+l.top+l.height/2);let s=null;if(r&&(s=r.closest(".field-component, .aifield-component"),!s&&r.previousSibling&&r.previousSibling.classList&&(r.previousSibling.classList.contains("field-component")||r.previousSibling.classList.contains("aifield-component"))&&(s=r.previousSibling)),!s){const d=t.getText(0,i),a=/\[(ai)?field:\s*([^\]]+)\]\[\/\1?field\]$/,f=d.match(a);if(f){const p=f[0],h=i-p.length;console.log("Deleting field (text pattern):",p,"from position",h),n.preventDefault(),n.stopPropagation(),t.deleteText(h,p.length,"user"),t.setSelection(h,0,"user"),setTimeout(()=>{b()},10);return}}if(s){console.log("Deleting field component:",s),n.preventDefault(),n.stopPropagation();const d=s.getAttribute("data-field-text");if(d){const f=t.getText().indexOf(d.replace(/\[field:\s*/,"[field: "));f!==-1&&(t.deleteText(f,d.length,"user"),t.setSelection(f,0,"user"))}s.remove(),setTimeout(()=>{b()},10)}}function ie(){if(!u||v===-1)return;const n=g;if(!n)return;const t=n.getSelection();if(!t)return;const e=n.getText(v+1,t.index-v-1);console.log("Text after slash:",e),H(e)}function oe(n){if(!c)return;const t=c.querySelectorAll(".slash-menu-item");t.length!==0&&(m=Math.max(0,Math.min(t.length-1,m+n)),M())}function le(){if(!c)return;const n=c.querySelectorAll(".slash-menu-item");if(n.length===0)return;const t=n[m];t&&t.click()}function M(){if(!c)return;c.querySelectorAll(".slash-menu-item").forEach((t,e)=>{e===m?t.style.backgroundColor="#f3f4f6":t.style.backgroundColor="transparent"})}function O(n){const t=g;if(!t||u)return;console.log("Showing slash menu at index:",n);const e=t.getBounds(n),i=t.container.getBoundingClientRect();C={x:i.left+e.left,y:i.top+e.top+e.height+5},console.log("Menu position:",C),H(""),u=!0}function S(){c&&(c.remove(),c=null),u=!1,v=-1,m=0}function H(n=""){c&&c.remove();const e=[{label:"AI Field",icon:"🤖",description:"Insert a predefined AI field",action:"ai"},{label:"Field",icon:"📝",description:"Create a custom field",action:"field"}].filter(i=>i.label.toLowerCase().startsWith(n.toLowerCase()));if(e.sort((i,o)=>i.label.localeCompare(o.label)),m=Math.min(m,e.length-1),e.length===0){S();return}c=document.createElement("div"),c.className="slash-menu",c.style.cssText=`
        position: fixed;
        left: ${C.x}px;
        top: ${C.y}px;
        background: white;
        ...
        font-size: 14px;
    `,e.forEach((i,o)=>{const l=se(i.label,i.icon,i.description);l.addEventListener("click",()=>{S(),i.action==="field"?P():i.action==="ai"&&W()}),c.appendChild(l)}),document.body.appendChild(c),M()}function se(n,t,e){const i=document.createElement("div");return i.className="slash-menu-item",i.style.cssText=`
        padding: 12px 16px;
        cursor: pointer;
        display: flex;
        align-items: center;
...
`||d==="	")break}if(l!==-1){const s=r-l;e.deleteText(l,s,"silent"),e.insertText(l,i,"silent"),e.setSelection(l+i.length,0,"silent")}else e.insertText(r,i,"silent"),e.setSelection(r+i.length,0,"silent")}else{const l=e.getLength();e.insertText(l-1,i,"silent"),e.setSelection(l-1+i.length,0,"silent")}setTimeout(()=>{console.log("Applying field styling after insertion"),b()},50)}function b(){const n=g;if(!n)return;if(x){console.log("Already applying styling, skipping...");return}x=!0,console.log("Applying field styling...");const t=n.container.querySelector(".ql-editor");if(!t){console.log("No editor element found"),x=!1;return}const e=n.getSelection(),i=n.hasFocus();let o=null;if(e&&i){const d=window.getSelection();d.rangeCount>0&&(o=d.getRangeAt(0).cloneRange())}const l=document.createTreeWalker(t,NodeFilter.SHOW_TEXT,null,!1),r=[];let s;for(;s=l.nextNode();)/\[(ai)?field:\s*[^\]]+\]\[\/\1?field\]/.test(s.textContent)&&r.push(s);if(r.length===0){x=!1;return}r.forEach(d=>{const a=d.textContent,f=/\[(ai)?field:\s*([^\]]+)\]\[\/\1?field\]/g;let p;const h=[];for(;(p=f.exec(a))!==null;)h.push({fullMatch:p[0],fieldName:p[2].trim(),isAIField:p[1]==="ai",startIndex:p.index,endIndex:p.index+p[0].length});if(h.length>0){const T=d.parentNode;let w=a,E=0;h.forEach(y=>{const $=document.createElement("div");$.innerHTML=y.isAIField?de(y.fieldName):re(y.fieldName);const Q=$.firstChild,D=w.substring(0,y.startIndex-E),k=w.substring(y.endIndex-E);if(D){const F=document.createTextNode(D);T.insertBefore(F,d)}if(T.insertBefore(Q,d),k===""||k.charAt(0)!==" "){const F=document.createTextNode("​");T.insertBefore(F,d)}w=k,E=y.endIndex}),w?d.textContent=w:T.removeChild(d)}}),i&&setTimeout(()=>{try{if(n.focus(),o){const d=window.getSelection();d.removeAllRanges(),d.addRange(o)}else e&&n.setSelection(e.index,e.length,"silent")}catch(d){console.log("Could not restore cursor position:",d),n.focus()}},1),setTimeout(()=>{x=!1,console.log("Styling application complete")},10)}function re(n){const t=`field-${Date.now()}-${Math.random().toString(36).substr(2,9)}`,e=`<span class="field-component" data-field-text="[field: ${n}][/field]" data-field-name="${n}" id="${t}" contenteditable="false" style="display: inline-block; background: #fefce8; border: 1px solid #eab308; border-radius: 4px; padding: 2px 6px 4px 6px; margin: 0 2px; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; cursor: default; vertical-align: baseline; line-height: 1.2; isolation: isolate;">
    ...
    `,B.forEach((l,r)=>{const s=document.createElement("div");s.className="ai-field-option",s.style.cssText=`
        ...
        `,s.addEventListener("mouseenter",function(){this.style.backgroundColor="#f8fafc"}),s.addEventListener("mouseleave",function(){this.style.backgroundColor="transparent"}),s.addEventListener("click",()=>{console.log("Selected AI field:",l),q(l,!0),n.remove()}),t.appendChild(s)});const e=document.createElement("div");e.style.cssText=`
        display: flex;
        justify-content: flex-end;
        margin-top: 16px;
    ...
    `;return t==="primary"?(e.style.cssText=i+`
        ...
        `,e.addEventListener("mouseenter",function(){this.style.backgroundColor="#2563eb",this.style.borderColor="#2563eb"}),e.addEventListener("mouseleave",function(){this.style.backgroundColor="#3b82f6",this.style.borderColor="#3b82f6"})):(e.style.cssText=i+`
            ...
            border-color: #d1d5db;
            color: #374151;
        `,e.addEventListener("mouseenter",function(){this.style.backgroundColor="#f9fafb"}),e.addEventListener("mouseleave",function(){this.style.backgroundColor="white"})),e}function ae(){S(),document.querySelectorAll(".field-modal").forEach(t=>t.remove()),window.fieldStylingTimeout&&(clearTimeout(window.fieldStylingTimeout),window.fieldStylingTimeout=null),g=null,u=!1,c=null,x=!1,j.clear()}function ce(){document.readyState==="loading"?document.addEventListener("DOMContentLoaded",function(){setTimeout(L,100)}):setTimeout(L,100)}window.initializeFields=L;window.getQuillInstance=I;window.insertField=G;window.updateField=V;window.removeField=K;window.getAllFields=N;window.getTextWithFields=R;window.validateFields=X;window.toggleFieldsHighlight=J;window.exportWithFields=Y;window.importWithFields=Z;window.handleFieldShortcuts=ee;window.showSlashMenu=O;window.showFieldNameInput=P;window.showAIFieldOptions=W;window.insertFieldIntoDocument=q;window.setupFieldEventListeners=z;window.cleanupFields=ae;ce();
